...
public class PixCropView: UIView {
  ...
  private func initPixCropImage() {
    ...
    PixCropImage.originalSize = LayoutUtils.scaledSizeToFit(
      size: image.size,
  ...
  private func updateImageView() {
    ...
    self.imageView.transform = CGAffineTransform(
      scaleX: PixCropImage.transformScale.x * PixCropImage.zoomScale,
      y: PixCropImage.transformScale.y * PixCropImage.zoomScale
